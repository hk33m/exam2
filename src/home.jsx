  ...
  const handelbutton = ()=>{
    ...
    return(
        ...
        <motion.button
         ...
         disabled={name==""}
        className="w-full cursor-pointer bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl text-lg shadow-lg disabled:bg-gray-300 disabled:cursor-not-allowed">{name!=="" ? "إكمال الاسئلة" : "بدء الاسئلة"} </motion.button>
        </motion.div>
        </AnimatePresence>
        </div>
